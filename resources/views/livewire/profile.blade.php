                      ...
                      <form wire:submit.prevent="updateProfile" class="space-y-6">
                          ...
                          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div>
                                  ...
                                  <div class="flex items-center">
                                      ...
                                      <input type="file" wire:model="tempPhoto" id="profile_photo" class="hidden">
                                  </div>
                              ...
                              <div>
                                  ...
                                  <div class="relative">
                                      ...
                                      <input type="text" wire:model="name" id="name" class="pl-10 w-full border-gray-300 rounded-lg shadow-sm focus:border-navy focus:ring focus:ring-navy focus:ring-opacity-50 transition duration-300">
                                  </div>
                              ...
                              <div>
                                  ...
                                  <div class="relative">
                                      ...
                                      <input type="email" wire:model="email" id="email" class="pl-10 w-full border-gray-300 rounded-lg shadow-sm focus:border-navy focus:ring focus:ring-navy focus:ring-opacity-50 transition duration-300">
                                  </div>
                              ...
                              <div>
                                  ...
                                  <div class="relative">
                                      ...
                                      <input type="tel" wire:model="phone" id="phone" class="pl-10 w-full border-gray-300 rounded-lg shadow-sm focus:border-navy focus:ring focus:ring-navy focus:ring-opacity-50 transition duration-300">
                                  </div>
                          ...
                          <div>
                              ...
                              <div class="relative">
                                  ...
                                  <textarea wire:model="address" id="address" rows="3" class="pl-10 w-full border-gray-300 rounded-lg shadow-sm focus:border-navy focus:ring focus:ring-navy focus:ring-opacity-50 transition duration-300"></textarea>
                              </div>
                      ...
                      <form wire:submit.prevent="updatePassword" class="space-y-6">
                          <div>
                              ...
                              <div class="relative">
                                  ...
                                  <input type="password" wire:model="current_password" id="current_password" class="pl-10 w-full border-gray-300 rounded-lg shadow-sm focus:border-navy focus:ring focus:ring-navy focus:ring-opacity-50 transition duration-300">
                              </div>
                          ...
                          <div>
                              ...
                              <div class="relative">
                                  ...
                                  <input type="password" wire:model="new_password" id="new_password" class="pl-10 w-full border-gray-300 rounded-lg shadow-sm focus:border-navy focus:ring focus:ring-navy focus:ring-opacity-50 transition duration-300">
                              </div>
                          ...
                          <div>
                              ...
                              <div class="relative">
                                  ...
                                  <input type="password" wire:model="confirm_password" id="confirm_password" class="pl-10 w-full border-gray-300 rounded-lg shadow-sm focus:border-navy focus:ring focus:ring-navy focus:ring-opacity-50 transition duration-300">
                              </div>
